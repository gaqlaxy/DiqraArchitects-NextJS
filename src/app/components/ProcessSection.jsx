...
//   // Add scroll animation - ALL TEXT ANIMATES SIMULTANEOUSLY
//   const { containerRef } = useScrollAnimation({
//     start: "top 70%",
//     animations: [
//       // Left column heading
//       {
//         selector: ".arch-left-heading",
...
//       {
//         selector: ".arch-main-heading",
//         ...animationPresets.fadeInUp,
//         delay: 0,
//       },
//       // Sub heading paragraph
//       {
//         selector: ".arch-sub-heading",
//         ...animationPresets.fadeInUp,
//         delay: 0,
//       },
//       // Grid item titles (all at once, no stagger)
//     ],
//   });
...
//   return (
//     <div className="arch-process-section" ref={containerRef}>
//       <div className="arch-container">
//         {/* LEFT COLUMN: Sticky Visuals */}
//         <div className="arch-left-col">
//           <h2 className="arch-left-heading">Our Process</h2>
...
//           <div className="arch-cta-block"></div>
//         </div>
//       </div>
//       <div className="cta-block-process">
//         <SlideUpButton href="/process" className="ml-4">
