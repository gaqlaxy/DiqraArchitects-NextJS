export const categories = [
  // --- CORE CONSTRUCTION ---
  {
    ...
    description:
      "A premier construction firm dedicated to delivering large-scale infrastructure with military-grade precision.",
    image: "/images/services/construction-companies.jpg",
    thumbnail: "/images/services/construction-companies-thumb.jpg",
    features: [
      { title: "Turnkey Projects", desc: "End-to-end execution." },
      { title: "Safety", desc: "OSHA compliant." },
    ],
    process: [
      { step: "01", name: "Plan", detail: "Site Analysis" },
      { step: "02", name: "Build", detail: "Execution" },
    ],
    stats: [
  ...
  },
  {
    ...
    description:
      "Crafting premium residential and commercial spaces that redefine luxury and functional living.",
    image: "/images/services/builders-and-developers.jpg",
    thumbnail: "/images/services/builders-and-developers.jpg",
    features: [
      { title: "Land Acquisition", desc: "Prime locations." },
      { title: "Legal", desc: "100% RERA compliant." },
    ],
    process: [
      { step: "01", name: "Master Plan", detail: "Zoning & Layout" },
      { step: "02", name: "Develop", detail: "Construction" },
    ],
    stats: [
      { label: "Acres", value: "100+" },
      { label: "Units", value: "1200+" },
    ],
  },
  {
    ...
    description:
      "Your trusted partner for executing complex architectural designs into reality.",
    image: "/images/services/building-contractors.jpg",
    thumbnail: "/images/services/building-contractors.jpg",
    features: [
      { title: "Labor", desc: "Skilled workforce." },
      { title: "Material", desc: "Direct sourcing." },
    ],
    process: [
      { step: "01", name: "Quote", detail: "BOQ Estimation" },
      { step: "02", name: "Build", detail: "Site work" },
    ],
    stats: [
      { label: "Contractors", value: "50+" },
  ...
  },
  {
    ...
    description:
      "Leading the way in heavy civil construction and infrastructure development with a focus on durability.",
    image: "/images/services/civil-contractors.jpg",
    thumbnail: "/images/services/civil-contractors.jpg",
    features: [
      { title: "RCC Work", desc: "Heavy structural framing." },
      { title: "Foundations", desc: "Deep piling." },
    ],
    process: [
      { step: "01", name: "Survey", detail: "Soil testing" },
      { step: "02", name: "Structure", detail: "Framing" },
    ],
    stats: [
      { label: "Concrete", value: "1M m3" },
      { label: "Steel", value: "50k Tons" },
    ],
  },
  {
    slug: "builders",
    ...
    description:
      "Reliable building services for individual homes and commercial shops.",
    image: "/images/services/builders.jpg",
    thumbnail: "/images/services/builders.jpg",
    features: [
      { title: "Cost Effective", desc: "Budget friendly." },
      { title: "Durable", desc: "Long lasting." },
    ],
    process: [
      { step: "01", name: "Design", detail: "Floor plans" },
      { step: "02", name: "Construct", detail: "Brick work" },
    ],
    stats: [
  ...
  },
  {
    ...
    description:
      "Specialized in creating warm, functional, and aesthetic residential spaces.",
    image: "/images/services/residential-builders.jpg",
    thumbnail: "/images/services/residential-builders.jpg",
    features: [
      { title: "Custom Homes", desc: "Tailored designs." },
      { title: "Vastu", desc: "Compliant layouts." },
    ],
    process: [
      { step: "01", name: "Consult", detail: "Needs analysis" },
      { step: "02", name: "Handover", detail: "Key delivery" },
    ],
    stats: [
      { label: "Villas", value: "150+" },
  ...
  },
  {
    ...
    description:
      "Focused on large-scale residential projects like gated communities and societies.",
    ...
    features: [
      { title: "Mass Housing", desc: "Efficient build." },
      { title: "Amenities", desc: "Clubhouses & Parks." },
    ],
    process: [
      { step: "01", name: "Plan", detail: "Master layout" },
      { step: "02", name: "Infra", detail: "Roads & Utils" },
    ],
    stats: [
      { label: "Units", value: "1000+" },
      { label: "Area", value: "2M sqft" },
    ],
  },
  {
    ...
    description:
      "Building high-performance commercial spaces including shopping complexes and offices.",
    image: "/images/services/commercial-builders.jpg",
    thumbnail: "/images/services/commercial-builders.jpg",
    features: [
      { title: "High Footfall", desc: "Optimized flow." },
      { title: "Facade", desc: "Glass & ACP." },
    ],
    process: [
      { step: "01", name: "Zone", detail: "FSI check" },
      { step: "02", name: "Build", detail: "Shell & Core" },
    ],
    stats: [
      { label: "Malls", value: "12" },
      { label: "Offices", value: "45" },
    ],
  },
  {
    ...
    description:
      "Heavy-duty construction for factories, warehouses, and manufacturing plants.",
    ...
    features: [
      { title: "PEB", desc: "Pre-engineered buildings." },
      { title: "Flooring", desc: "VDF/Epoxy." },
    ],
    process: [
      { step: "01", name: "Fab", detail: "Steel fabrication" },
      { step: "02", name: "Erect", detail: "On-site assembly" },
    ],
    stats: [
      { label: "Factories", value: "30+" },
  ...
  },
  {
    ...
    features: [
      { title: "Green Building", desc: "LEED certified." },
      { title: "Tech", desc: "Smart integration." },
    ],
    process: [
      { step: "01", name: "Strategy", detail: "Workplace planning" },
      { step: "02", name: "Fitout", detail: "Interior finish" },
    ],
    stats: [
      { label: "IT Parks", value: "5" },
  ...
  // --- ARCHITECTS ---
  {
    ...
    features: [
      { title: "Concept", desc: "Initial sketches." },
      { title: "3D", desc: "Realistic renders." },
    ],
    process: [
      { step: "01", name: "Brief", detail: "Client meeting" },
      { step: "02", name: "Draft", detail: "CAD drawings" },
    ],
    stats: [
  ...
  },
  {
    ...
    description:
      "Creating immersive interior environments that reflect your personality.",
    image: "/images/services/interior-designers.jpg",
    thumbnail: "/images/services/interior-designers.jpg",
    features: [
      { title: "Space Plan", desc: "Optimized layout." },
      { title: "Decor", desc: "Curated furniture." },
    ],
    process: [
      { step: "01", name: "Moodboard", detail: "Theme selection" },
      { step: "02", name: "Install", detail: "Fit-out" },
    ],
    stats: [
  ...
  },
  {
    ...
    description:
      "Office interiors that boost employee morale and brand identity.",
    image: "/images/services/interior-designers-for-office.jpg",
    thumbnail: "/images/services/interior-designers-for-office.jpg",
    features: [
      { title: "Ergonomics", desc: "Comfort focus." },
      { title: "Acoustics", desc: "Noise control." },
    ],
    process: [
      { step: "01", name: "Plan", detail: "Desk layout" },
      { step: "02", name: "Branding", detail: "Visual identity" },
    ],
    stats: [
      { label: "Offices", value: "150+" },
      { label: "Desks", value: "5000+" },
    ],
  },
  {
    ...
    description:
      "Architectural services dedicated to individual villas and bungalows.",
    image: "/images/services/architects-for-residential.jpg",
    thumbnail: "/images/services/architects-for-residential.jpg",
    features: [
      { title: "Personal", desc: "Tailored to you." },
      { title: "Elevation", desc: "Curb appeal." },
    ],
    process: [
      { step: "01", name: "Consult", detail: "Lifestyle check" },
      { step: "02", name: "Draw", detail: "Blueprints" },
    ],
    stats: [
      { label: "Homes", value: "200+" },
      { label: "Designs", value: "Unique" },
    ],
  },
  {
    ...
    description:
      "Architectural planning for multi-story buildings, maximizing FSI.",
    image: "/images/services/architects-for-building.jpg",
    thumbnail: "/images/services/architects-for-building.jpg",
    features: [
      { title: "FSI", desc: "Max utilization." },
      { title: "Lobbies", desc: "Grand entrances." },
    ],
    process: [
      { step: "01", name: "Feasibility", detail: "Code check" },
      { step: "02", name: "Permit", detail: "Liaisoning" },
    ],
    stats: [
      { label: "Towers", value: "40+" },
      { label: "Floors", value: "500+" },
    ],
  },
  {
    ...
    description:
      "Architectural design for office buildings and corporate parks.",
    image: "/images/services/architects-for-office.jpg",
    thumbnail: "/images/services/architects-for-office.jpg",
    features: [
      { title: "Facade", desc: "Glass glazing." },
      { title: "Efficiency", desc: "Floor plate optimization." },
    ],
    process: [
      { step: "01", name: "Concept", detail: "Massing" },
      { step: "02", name: "Detail", detail: "GFC Drawings" },
    ],
    stats: [
      { label: "Sqft", value: "1M+" },
      { label: "Clients", value: "MNCs" },
    ],
  },
  {
    ...
    features: [
      { title: "Load Calc", desc: "Seismic analysis." },
      { title: "Detailing", desc: "Bar bending schedule." },
    ],
    process: [
      { step: "01", name: "Analyze", detail: "STAAD Pro" },
      { step: "02", name: "Draft", detail: "Structural sheets" },
    ],
    stats: [
      { label: "Safety", value: "100%" },
      { label: "Steel", value: "Optimized" },
    ],
  },
  {
    ...
    features: [
      { title: "Privacy", desc: "No overlooking." },
      { title: "Ventilation", desc: "Cross air flow." },
    ],
    process: [
      { step: "01", name: "Layout", detail: "Unit planning" },
      { step: "02", name: "Common", detail: "Area design" },
    ],
    stats: [
      { label: "Units", value: "5000+" },
      { label: "Complexes", value: "50+" },
    ],
  },
  {
    ...
    description:
      "Architectural design with a heavy focus on civil engineering constraints.",
    image: "/images/services/civil-architects.jpg",
    thumbnail: "/images/services/civil-architects.jpg",
    features: [
      { title: "Technical", desc: "Feasibility focus." },
      { title: "Robust", desc: "Strong structures." },
    ],
    process: [
      { step: "01", name: "Survey", detail: "Site data" },
      { step: "02", name: "Plan", detail: "Technical drawing" },
    ],
    stats: [
      { label: "Exp", value: "20 Yrs" },
      { label: "Projects", value: "Technical" },
    ],
  },
  {
    ...
    features: [
      { title: "Hardscape", desc: "Pathways & Gazebos." },
      { title: "Plants", desc: "Native species." },
    ],
    process: [
      { step: "01", name: "Topography", detail: "Level survey" },
      { step: "02", name: "Planting", detail: "Selection" },
    ],
    stats: [
      { label: "Acres", value: "50+" },
      { label: "Gardens", value: "100+" },
    ],
  },
  {
    ...
    description:
      "Blending modern luxury with rustic landscapes for getaway homes.",
    image: "/images/services/architects-for-farm-house.jpg",
    thumbnail: "/images/services/architects-for-farm-house.jpg",
    features: [
      { title: "Open", desc: "Verandahs & Courtyards." },
      { title: "Nature", desc: "Integrated views." },
    ],
    process: [
      { step: "01", name: "Site", detail: "Location study" },
      { step: "02", name: "Design", detail: "Rustic modern" },
    ],
    stats: [
      { label: "Retreats", value: "25+" },
      { label: "Relax", value: "100%" },
    ],
  },
  {
    ...
    features: [
      { title: "Theme", desc: "Immersive design." },
      { title: "Guest Flow", desc: "Service privacy." },
    ],
    process: [
      { step: "01", name: "Masterplan", detail: "Zoning" },
      { step: "02", name: "Cottages", detail: "Unit design" },
    ],
    stats: [
      { label: "Resorts", value: "10+" },
  ...
  },
  {
    ...
    description:
      "Healthcare facilities prioritizing patient safety and sterile zones.",
    image: "/images/services/architects-for-hospital.jpg",
    thumbnail: "/images/services/architects-for-hospital.jpg",
    features: [
      { title: "Sterile", desc: "OT & ICU design." },
      { title: "NABH", desc: "Compliant layouts." },
    ],
    process: [
      { step: "01", name: "Med-Plan", detail: "Flow check" },
      { step: "02", name: "MEP", detail: "Medical gases" },
    ],
    stats: [
      { label: "Hospitals", value: "10" },
      { label: "Beds", value: "2000+" },
    ],
  },
  {
    ...
    description:
      "Themed interiors and efficient kitchen layouts for culinary spaces.",
    image: "/images/services/architects-for-restaurant.jpg",
    thumbnail: "/images/services/architects-for-restaurant.jpg",
    features: [
      { title: "Kitchen", desc: "Workflow optimized." },
      { title: "Ambiance", desc: "Lighting & Decor." },
    ],
    process: [
      { step: "01", name: "Concept", detail: "Theme" },
      { step: "02", name: "Kitchen", detail: "Service layout" },
    ],
    stats: [
      { label: "Outlets", value: "50+" },
      { label: "Cafes", value: "20+" },
    ],
  },
  {
    ...
    features: [
      { title: "Passive", desc: "Natural cooling." },
      { title: "Materials", desc: "Locally sourced." },
    ],
    process: [
      { step: "01", name: "Climate", detail: "Sun path analysis" },
      { step: "02", name: "Design", detail: "Green building" },
    ],
    stats: [
      { label: "Carbon", value: "Reduced" },
      { label: "Energy", value: "Saved" },
    ],
  },
  {
    ...
    description:
      "Contemporary interpretation of Islamic geometric motifs and arches.",
    image: "/images/services/islamic-architects.jpg",
    thumbnail: "/images/services/islamic-architects.jpg",
    features: [
      { title: "Geometry", desc: "Intricate patterns." },
      { title: "Privacy", desc: "Screen walls (Jaali)." },
    ],
    process: [
      { step: "01", name: "Study", detail: "Cultural research" },
      { step: "02", name: "Design", detail: "Fusion style" },
    ],
    stats: [
  ...
  },
  {
    ...
    description:
      "Stimulating educational environments with safe play areas and bright classrooms.",
    image: "/images/services/architects-for-school.jpg",
    thumbnail: "/images/services/architects-for-school.jpg",
    features: [
      { title: "Safety", desc: "Child-friendly." },
      { title: "Light", desc: "Natural daylight." },
    ],
    process: [
      { step: "01", name: "Campus", detail: "Master planning" },
      { step: "02", name: "Class", detail: "Interior layout" },
    ],
    stats: [
  ...
  },
  {
    ...
    features: [
      { title: "Certification", desc: "LEED/GRIHA." },
      { title: "Water", desc: "Rainwater harvest." },
    ],
    process: [
      { step: "01", name: "Audit", detail: "Pre-cert check" },
      { step: "02", name: "Submit", detail: "Documentation" },
    ],
    stats: [
  ...
  },
  {
    ...
    features: [
      { title: "Identity", desc: "Brand architecture." },
      { title: "Scale", desc: "Large format." },
    ],
    process: [
      { step: "01", name: "Vision", detail: "Brand alignment" },
      { step: "02", name: "Design", detail: "Landmark creation" },
    ],
    stats: [
      { label: "HQ", value: "5" },
      { label: "Brands", value: "Top Tier" },
    ],
  },
  {
    ...
    features: [
      { title: "Joinery", desc: "Expert craftsmanship." },
      { title: "Warmth", desc: "Natural insulation." },
    ],
    process: [
      { step: "01", name: "Select", detail: "Timber sourcing" },
      { step: "02", name: "Build", detail: "Prefab assembly" },
    ],
    stats: [
      { label: "Houses", value: "20+" },
      { label: "Eco", value: "High" },
    ],
  },
  {
    ...
    description:
      "Church architecture focusing on acoustics and congregational flow.",
    image: "/images/services/architects-for-church.jpg",
    thumbnail: "/images/services/architects-for-church.jpg",
    features: [
      { title: "Acoustics", desc: "Choir & Sermon." },
      { title: "Light", desc: "Stained glass." },
    ],
    process: [
      { step: "01", name: "Volume", detail: "Height planning" },
      { step: "02", name: "Detail", detail: "Altar design" },
    ],
    stats: [
      { label: "Churches", value: "12" },
      { label: "Seats", value: "5000+" },
    ],
  },
  {
    ...
    features: [
      { title: "Shastras", desc: "Vedic compliance." },
      { title: "Carving", desc: "Stone detailing." },
    ],
    process: [
      { step: "01", name: "Grid", detail: "Vastu Purusha Mandala" },
      { step: "02", name: "Sculpt", detail: "Stone work" },
    ],
    stats: [
      { label: "Temples", value: "8" },
      { label: "Restored", value: "5" },
    ],
  },
  ...
  // --- CONSULTANTS & APPROVALS ---
  {
    ...
    features: [
      { title: "Tracking", desc: "MSP/Primavera." },
      { title: "Cost", desc: "Budget control." },
    ],
    process: [
      { step: "01", name: "Schedule", detail: "Timeline" },
      { step: "02", name: "Monitor", detail: "Daily reports" },
    ],
    stats: [
      { label: "Managed", value: "500Cr+" },
  ...
  },
  {
    ...
    description:
      "Expert liaison services to get your building plans sanctioned.",
    image: "/images/services/approvals.jpg",
    thumbnail: "/images/services/approvals.jpg",
    features: [
      { title: "Liaison", desc: "Govt coordination." },
      { title: "Legal", desc: "Clear titles." },
    ],
    process: [
      { step: "01", name: "Docs", detail: "Collection" },
      { step: "02", name: "Submit", detail: "Online filing" },
    ],
    stats: [
      { label: "Approvals", value: "1000+" },
  ...
  },
  {
    ...
    description:
      "Marketing and selling apartment complexes and gated communities.",
    image: "/images/services/flat-promoters.jpg",
    thumbnail: "/images/services/flat-promoters.jpg",
    features: [
      { title: "Marketing", desc: "Digital & Print." },
      { title: "Sales", desc: "Site visits." },
    ],
    process: [
      { step: "01", name: "Launch", detail: "Project go-live" },
      { step: "02", name: "Sell", detail: "Booking" },
    ],
    stats: [
      { label: "Sold", value: "500+" },
      { label: "Happy", value: "Families" },
    ],
  },
  {
    ...
    description:
      "Expert advice on construction methods, materials, and cost saving.",
    image: "/images/services/building-consultants.jpg",
    thumbnail: "/images/services/building-consultants.jpg",
    features: [
      { title: "Audit", desc: "Quality checks." },
      { title: "Advice", desc: "Material selection." },
    ],
    process: [
      { step: "01", name: "Inspect", detail: "Site visit" },
      { step: "02", name: "Report", detail: "Findings" },
    ],
    stats: [
      { label: "Consulted", value: "200+" },
      { label: "Expertise", value: "High" },
    ],
  },
  {
    ...
    description:
      "Solving complex civil engineering problems and structural challenges.",
    image: "/images/services/civil-consultants.jpg",
    thumbnail: "/images/services/civil-consultants.jpg",
    features: [
      { title: "Solutions", desc: "Problem solving." },
      { title: "Testing", desc: "Lab coordination." },
    ],
    process: [
      { step: "01", name: "Problem", detail: "Identification" },
      { step: "02", name: "Solve", detail: "Technical fix" },
    ],
    stats: [
  ...
  },
  {
    ...
    description:
      "Breathing new life into old structures through repair and remodeling.",
    image: "/images/services/renovation.jpg",
    thumbnail: "/images/services/renovation.jpg",
    features: [
      { title: "Repair", desc: "Structural fix." },
      { title: "Modernize", desc: "New look." },
    ],
    process: [
      { step: "01", name: "Demo", detail: "Strip down" },
      { step: "02", name: "Rebuild", detail: "New finish" },
    ],
    stats: [
      { label: "Renovated", value: "200+" },
      { label: "Value", value: "Increased" },
    ],
  },
  {
    ...
    features: [
      { title: "Gypsum", desc: "Seamless finish." },
      { title: "Lighting", desc: "Cove lights." },
    ],
    process: [
      { step: "01", name: "Frame", detail: "Channel fixing" },
      { step: "02", name: "Board", detail: "Installation" },
    ],
    stats: [
      { label: "Sqft", value: "5M+" },
      { label: "Designs", value: "Unlimited" },
    ],
  },
  ...
  // --- PAINTING ---
  {
    ...
    features: [
      { title: "Prep", desc: "Sanding & Putty." },
      { title: "Finish", desc: "Premium coats." },
    ],
    process: [
      { step: "01", name: "Protect", detail: "Masking" },
      { step: "02", name: "Paint", detail: "Application" },
    ],
    stats: [
      { label: "Walls", value: "10M sqft" },
  ...
  },
  {
    ...
    description:
      "Certified experts in applying the complete range of Asian Paints products.",
    image: "/images/services/asian-paints.jpg",
    thumbnail: "/images/services/asian-paints.jpg",
    features: [
      { title: "Royale", desc: "Luxury finish." },
      { title: "Texture", desc: "Wall art." },
    ],
    process: [
      { step: "01", name: "Consult", detail: "Color selection" },
      { step: "02", name: "Apply", detail: "Mechanized tools" },
    ],
    stats: [
  ...
  },
  {
    ...
    description:
      "High-gloss and matte PU/Duco finishing for furniture and doors.",
    image: "/images/services/duco.jpg",
    thumbnail: "/images/services/duco.jpg",
    features: [
      { title: "PU", desc: "Polyurethane." },
      { title: "Gloss", desc: "High shine." },
    ],
    process: [
      { step: "01", name: "Sand", detail: "Micro sanding" },
      { step: "02", name: "Spray", detail: "Booth finish" },
    ],
    stats: [
      { label: "Doors", value: "2000+" },
      { label: "Finish", value: "Glass-like" },
    ],
  },
  {
    ...
    description:
      "Authorized applicators for Berger Paints with express delivery.",
    image: "/images/services/berger.jpg",
    thumbnail: "/images/services/berger.jpg",
    features: [
      { title: "Express", desc: "Fast service." },
      { title: "Dust-Free", desc: "Clean tools." },
    ],
    process: [
      { step: "01", name: "Quote", detail: "Laser measure" },
      { step: "02", name: "Paint", detail: "Quick dry" },
    ],
    stats: [
      { label: "Speed", value: "Fast" },
  ...
  // --- INTERIOR NICHE ---
  {
    ...
    features: [
      { title: "Soft Furnishing", desc: "Curtains & Rugs." },
      { title: "Styling", desc: "Art placement." },
    ],
    process: [
      { step: "01", name: "Select", detail: "Shopping" },
      { step: "02", name: "Style", detail: "Placement" },
    ],
    stats: [
      { label: "Homes", value: "100+" },
      { label: "Style", value: "Chic" },
    ],
  },
  {
    ...
    description:
      "Ergonomic modular kitchen designs featuring Hettich/Blum fittings.",
    image: "/images/services/modular-kitchen.jpg",
    thumbnail: "/images/services/modular-kitchen.jpg",
    features: [
      { title: "Storage", desc: "Space saving." },
      { title: "Finish", desc: "Acrylic/Laminate." },
    ],
    process: [
      { step: "01", name: "Measure", detail: "Site check" },
      { step: "02", name: "Install", detail: "2-Day Fit" },
    ],
    stats: [
      { label: "Kitchens", value: "500+" },
  ...
  },
  {
    ...
    features: [
      { title: "Display", desc: "Product focus." },
      { title: "Lighting", desc: "Retail spec." },
    ],
    process: [
      { step: "01", name: "Layout", detail: "Flow" },
      { step: "02", name: "Fitout", detail: "Racks & Light" },
    ],
    stats: [
      { label: "Shops", value: "100+" },
      { label: "Sales", value: "Boosted" },
    ],
  },
  {
    ...
    features: [
      { title: "Team", desc: "Dedicated." },
      { title: "Quality", desc: "Checked." },
    ],
    process: [
      { step: "01", name: "Contract", detail: "Sign-off" },
      { step: "02", name: "Build", detail: "Daily work" },
    ],
    stats: [
      { label: "Homes", value: "50+" },
      { label: "Reliable", value: "Yes" },
    ],
  },
  {
    ...
    features: [
      { title: "Strong", desc: "Solid base." },
      { title: "Fast", desc: "Quick structure." },
    ],
    process: [
      { step: "01", name: "Dig", detail: "Excavation" },
      { step: "02", name: "Pour", detail: "Concrete" },
    ],
    stats: [
      { label: "Foundations", value: "100+" },
      { label: "Stable", value: "100%" },
    ],
  },
  {
    ...
    description:
      "Exclusive rooftop construction and lightweight structure additions.",
    image: "/images/services/penthouse.jpg",
    thumbnail: "/images/services/penthouse.jpg",
    features: [
      { title: "Lightweight", desc: "Steel structure." },
      { title: "View", desc: "Glass walls." },
    ],
    process: [
      { step: "01", name: "Load", detail: "Check capacity" },
      { step: "02", name: "Build", detail: "Rooftop work" },
    ],
    stats: [
  ...
  },
  {
    ...
    features: [
      { title: "Total", desc: "Full gut reno." },
      { title: "Facade", desc: "Modernize." },
    ],
    process: [
      { step: "01", name: "Strip", detail: "Demolition" },
      { step: "02", name: "New", detail: "Reconstruction" },
    ],
    stats: [
      { label: "Villas", value: "30+" },
      { label: "Value", value: "2x" },
    ],
  },
  {
    ...
    features: [
      { title: "Stretch", desc: "Gloss finish." },
      { title: "Print", desc: "Custom art." },
    ],
    process: [
      { step: "01", name: "Measure", detail: "Laser" },
      { step: "02", name: "Heat", detail: "Stretch fit" },
    ],
    stats: [
      { label: "Ceilings", value: "100+" },
      { label: "Wow", value: "Factor" },
    ],
  },
  {
    ...
    tagline: "Curb Appeal.",
    description:
      "Facade and front elevation design to make your home stand out.",
    image: "/images/services/exterior-design.jpg",
    thumbnail: "/images/services/exterior-design.jpg",
    features: [
      { title: "Materials", desc: "Stone & HPL." },
      { title: "Lighting", desc: "Facade lights." },
    ],
    process: [
      { step: "01", name: "3D", detail: "Visualize" },
      { step: "02", name: "Clad", detail: "Install" },
    ],
    stats: [
      { label: "Facades", value: "50+" },
  ...
  },
  {
    ...
    description:
      "Durable and waterproof PVC paneling solutions for walls and ceilings.",
    image: "/images/services/pvc-interior.jpg",
    thumbnail: "/images/services/pvc-interior.jpg",
    features: [
      { title: "Waterproof", desc: "No dampness." },
      { title: "Fast", desc: "1-day install." },
    ],
    process: [
      { step: "01", name: "Select", detail: "Pattern" },
      { step: "02", name: "Paste", detail: "Installation" },
    ],
    stats: [
  ...
  },
  {
    ...
    features: [
      { title: "Realism", desc: "4K Renders." },
      { title: "VR", desc: "Walkthrough." },
    ],
    process: [
      { step: "01", name: "Model", detail: "Build 3D" },
      { step: "02", name: "Render", detail: "Lighting" },
    ],
    stats: [
      { label: "Renders", value: "1000+" },
      { label: "Views", value: "Stunning" },
    ],
  },
  {
    ...
    features: [
      { title: "Clean", desc: "Easy wipe." },
      { title: "Look", desc: "Wood finish." },
    ],
    process: [
      { step: "01", name: "Frame", detail: "Grid" },
      { step: "02", name: "Lock", detail: "Panels" },
    ],
    stats: [
      { label: "Ceilings", value: "100+" },
      { label: "Life", value: "Long" },
    ],
  },
  {
    ...
    features: [
      { title: "Wet/Dry", desc: "Zone separation." },
      { title: "Luxury", desc: "Premium fittings." },
    ],
    process: [
      { step: "01", name: "Select", detail: "Tiles" },
      { step: "02", name: "Plumb", detail: "Installation" },
    ],
    stats: [
      { label: "Baths", value: "150+" },
      { label: "Relax", value: "Spa" },
    ],
  },
  {
    ...
    features: [
      { title: "Compact", desc: "Space saving." },
      { title: "Style", desc: "Modern." },
    ],
    process: [
      { step: "01", name: "Layout", detail: "Plan" },
      { step: "02", name: "Fit", detail: "Execute" },
    ],
    stats: [
      { label: "Flats", value: "300+" },
      { label: "Space", value: "Max" },
    ],
  },
  {
    ...
    features: [
      { title: "Clean", desc: "Clutter free." },
      { title: "Neutral", desc: "Color palette." },
    ],
    process: [
      { step: "01", name: "Edit", detail: "Remove clutter" },
      { step: "02", name: "Style", detail: "Simple" },
    ],
    stats: [
  ...
  },
  {
    ...
    features: [
      { title: "Grand", desc: "Double height." },
      { title: "Luxury", desc: "Materials." },
    ],
    process: [
      { step: "01", name: "Theme", detail: "Concept" },
      { step: "02", name: "Execute", detail: "Detailing" },
    ],
    stats: [
      { label: "Bungalows", value: "40+" },
      { label: "Lux", value: "High" },
    ],
  },
  {
    ...
    features: [
      { title: "Comfort", desc: "Cozy vibes." },
      { title: "Storage", desc: "Wardrobes." },
    ],
    process: [
      { step: "01", name: "Layout", detail: "Bed position" },
      { step: "02", name: "Decor", detail: "Soft furnishings" },
    ],
    stats: [
  ...
  },
  {
    ...
    features: [
      { title: "Flow", desc: "Connected spaces." },
      { title: "Opulence", desc: "Rich finish." },
    ],
    process: [
      { step: "01", name: "Concept", detail: "Master theme" },
      { step: "02", name: "Build", detail: "Fitout" },
    ],
    stats: [
      { label: "Villas", value: "30+" },
      { label: "Class", value: "Top" },
    ],
  },
  {
    ...
    features: [
      { title: "Focus", desc: "Distraction free." },
      { title: "Tech", desc: "Cable management." },
    ],
    process: [
      { step: "01", name: "Plan", detail: "Ergonomics" },
      { step: "02", name: "Setup", detail: "Install" },
    ],
    stats: [
      { label: "Offices", value: "100+" },
      { label: "Productive", value: "Yes" },
    ],
  },
  {
    ...
    features: [
      { title: "Preview", desc: "Color check." },
      { title: "Layout", desc: "Usage flow." },
    ],
    process: [
      { step: "01", name: "Draft", detail: "Layout" },
      { step: "02", name: "Render", detail: "3D View" },
    ],
    stats: [
  ...
  },
  {
    ...
    features: [
      { title: "Clean", desc: "No mess." },
      { title: "Fast", desc: "Quick turn." },
    ],
    process: [
      { step: "01", name: "Prep", detail: "Covering" },
      { step: "02", name: "Paint", detail: "Coating" },
    ],
    stats: [
      { label: "Homes", value: "1000+" },
      { label: "Fresh", value: "Look" },
    ],
  },
  {
    ...
    features: [
      { title: "Flow", desc: "Customer path." },
      { title: "Display", desc: "Highlight." },
    ],
    process: [
      { step: "01", name: "Plan", detail: "Zoning" },
      { step: "02", name: "Fit", detail: "Shelving" },
    ],
    stats: [
      { label: "Shops", value: "80+" },
  ...
  },
  {
    ...
    features: [
      { title: "Welcome", desc: "Grand lobby." },
      { title: "Comfort", desc: "Room design." },
    ],
    process: [
      { step: "01", name: "Concept", detail: "Theme" },
      { step: "02", name: "Build", detail: "Furnish" },
    ],
    stats: [
      { label: "Hotels", value: "10+" },
      { label: "Guests", value: "Happy" },
    ],
  },
  {
    ...
    features: [
      { title: "Mood", desc: "Lighting." },
      { title: "Seat", desc: "Capacity plan." },
    ],
    process: [
      { step: "01", name: "Theme", detail: "Story" },
      { step: "02", name: "Fit", detail: "Decor" },
    ],
    stats: [
      { label: "Cafes", value: "30+" },
      { label: "Vibe", value: "Good" },
    ],
  },
  {
    ...
    features: [
      { title: "Art", desc: "Wall decor." },
      { title: "Plants", desc: "Greenery." },
    ],
    process: [
      { step: "01", name: "Select", detail: "Items" },
      { step: "02", name: "Place", detail: "Styling" },
    ],
    stats: [
      { label: "Offices", value: "50+" },
      { label: "Style", value: "Pro" },
    ],
  },
  {
    ...
    features: [
      { title: "Soft", desc: "Fabrics." },
      { title: "Accents", desc: "Vases & Art." },
    ],
    process: [
      { step: "01", name: "Shop", detail: "Selection" },
      { step: "02", name: "Style", detail: "Setup" },
    ],
    stats: [
      { label: "Homes", value: "200+" },
      { label: "Cozy", value: "Yes" },
    ],
  },
  {
    ...
    features: [
      { title: "Focus", desc: "Product light." },
      { title: "Prop", desc: "Staging." },
    ],
    process: [
      { step: "01", name: "Plan", detail: "Visual merch" },
      { step: "02", name: "Set", detail: "Display" },
    ],
    stats: [
      { label: "Showrooms", value: "40+" },
      { label: "Look", value: "Sharp" },
    ],
  },
  {
    ...
    features: [
      { title: "Window", desc: "Display." },
      { title: "Sign", desc: "Branding." },
    ],
    process: [
      { step: "01", name: "Design", detail: "Concept" },
      { step: "02", name: "Install", detail: "Props" },
    ],
    stats: [
      { label: "Shops", value: "60+" },
      { label: "Footfall", value: "Up" },
    ],
  },
  {
    ...
    features: [
      { title: "Org", desc: "Jars & Bins." },
      { title: "Light", desc: "Under cab." },
    ],
    process: [
      { step: "01", name: "Audit", detail: "Needs" },
      { step: "02", name: "Style", detail: "Organize" },
    ],
    stats: [
      { label: "Kitchens", value: "100+" },
      { label: "Neat", value: "Yes" },
    ],
  },
  {
    ...
    features: [
      { title: "Luxury", desc: "Linens." },
      { title: "Art", desc: "Framed work." },
    ],
    process: [
      { step: "01", name: "Source", detail: "Bulk buy" },
      { step: "02", name: "Install", detail: "Room setup" },
    ],
    stats: [
      { label: "Rooms", value: "500+" },
  ...
  },
  {
    ...
    features: [
      { title: "Table", desc: "Setting." },
      { title: "Wall", desc: "Mural/Art." },
    ],
    process: [
      { step: "01", name: "Theme", detail: "Select" },
      { step: "02", name: "Style", detail: "Tables" },
    ],
    stats: [
      { label: "Restaurants", value: "25+" },
      { label: "Instagram", value: "Ready" },
    ],
  },
];
